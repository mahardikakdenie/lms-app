<template>
    <div class="container py-6">
        ...
        <div class="mt-[20px]">
            <h2 class="text-2xl">Tentang Bimba</h2>
            <span
                class="bg-blue-100 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300"
            >
                Recently updated on Desember 14th, 2020 at 08:37 am
            </span>
        </div>
        ...
        <div class="mt-[30px]">
            <div class="font-bold text-2xl">Apa Itu Bimba</div>
            <p class="text-justify mt-2">
                ...
                suatu dengan suatu lainnya untuk perbaikan diri dan lingkungannya. Salah satu bagian dari biMBA, biMBA
                AIUEO adalah proses bimbingan Minat Baca Anak yang bertujuan agar anak Minat, senang, suka, dan gemar
                membaca sehingga terbangun pondasi karakter gemar membaca. Kegiatan membaca merupakan bagian terpenting
