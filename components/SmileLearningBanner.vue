<template>
    <div
        class="relative my-14 mx-auto border-[10px] border-transparent shadow-2xl py-6 dark:border-black dark:bg-gray-dark lg:my-[100px] lg:py-[100px] xl:max-w-[1440px] xl:rounded-3xl"
    >
        <div class="container">
            <div class="items-end gap-4 lg:flex xl:gap-0">
                <div class="lg:w-1/2 relative">
                    ...
                    <div
                        class="grid gap-x-7 gap-y-12 sm:grid-cols-2 aos-init aos-animate mt-[20px]"
                        data-aos="fade-right"
